    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-sm-12 text-center">
                        <div class="pilihanDaf">Yo <a href=""><?php echo $user ?></a>! <a href="<?= base_url(); ?>Login" class="daftar" style="text-decoration:underline;">Dashboard</a> | <a href="<?= base_url(); ?>Register" class="daftar" style=" text-decoration:underline;">Inbox</a> | <a href="<?= base_url(); ?>Register" class="daftar" style=" text-decoration:underline;">Logout</a></p>
                            </div>
                    </div>
                </div>
                <div class="col-sm-4">
        ...
        <div class="container barisGambar">
            <nav>
                <ul class="nav justify-content-start">
                    <li class="nav-item">
                        <img src="<?php echo base_url('assets/gambar1.png') ?>">
                    </li>
                    <li class="nav-item">
                        <img src="<?php echo base_url('assets/gambar2.jpg') ?>">
                    </li>
                    <li class="nav-item">
                        <img src="<?php echo base_url('assets/gambar3.jpg') ?>">
                    </li>
                    <li class="nav-item">
                        <img src="<?php echo base_url('assets/gambar4.jpg') ?>">
                    </li>
                    <li class="nav-item">
                        <img src="<?php echo base_url('assets/gambar5.jpg') ?>">
                    </li>
                    </ul>
                </nav>
        </div>
